...
set output 'graphs/detail-speedup-log.pdf'

set style data histogram
set style histogram cluster gap 4

set ylabel "Speedup Relative to MRI (s/s)"
set key top left
...
plot 'graphs/detail-speedup.data' using 2:xtic(1) linecolor rgb '#cc0000' title col, \
